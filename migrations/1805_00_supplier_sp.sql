DROP IF EXISTS PROCEDURE quartz.SupplierRatingReport;
CREATE DEFINER=`RootDBMS`@`127.0.0.1` PROCEDURE quartz.`SupplierRatingReport`(IN `CatalogId` VARCHAR(255), IN `RegionCode` VARCHAR(255), IN `DateFrom` datetime, IN `DateTo` datetime)
BEGIN
